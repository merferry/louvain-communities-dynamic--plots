...
set output 'deletions-modularity-all.pdf'
...
plot 'deletions/'.word(files, i).'.csv' \
       using 4:($9 ) title 'Static'            linestyle 1 with linespoints, \
    '' using 4:($10) title 'Naive-dynamic'     linestyle 2 with linespoints, \
    '' using 4:($11) title 'Delta-screening'   linestyle 3 with linespoints, \
    '' using 4:($12) title 'Dynamic Frontier'  linestyle 4 with linespoints,
}
unset multiplot
