...
set output 'deletions-runtime-mean.pdf'
...
plot 'deletions.csv' \
  ...
  '' using 4:($5 /1000):($4==1e-1? sprintf("%.1f", $5/$5) : "") with labels notitle offset character -2.2,character 0.7 textcolor linetype 6, \
  '' using 4:($6 /1000):($4==1e-7? sprintf("%.1f", $5/$6) : "") with labels notitle offset character 2.2,character 0.6 textcolor linetype 7, \
  '' using 4:($6 /1000):($4>=1e-6 && $4 <1e-4? sprintf("%.1f", $5/$6) : "") with labels notitle offset character 0,character 0.6 textcolor linetype 7, \
  '' using 4:($6 /1000):($4>=1e-4 && $4 <1e-2? sprintf("%.1f", $5/$6) : "") with labels notitle offset character 0,character -0.6 textcolor linetype 7, \
  '' using 4:($6 /1000):($4==1e-2? sprintf("%.1f", $5/$6) : "") with labels notitle offset character -2.0,character -0.6 textcolor linetype 7, \
  '' using 4:($7 /1000):($4==1e-7? sprintf("%.1f", $5/$7) : "") with labels notitle offset character 2.2,character -0.6 textcolor linetype 2, \
  '' using 4:($7 /1000):($4>=1e-6 && $4 <1e-4? sprintf("%.1f", $5/$7) : "") with labels notitle offset character 0,character -0.6 textcolor linetype 2, \
  '' using 4:($7 /1000):($4>=1e-4 && $4 <1e-1? sprintf("%.1f", $5/$7) : "") with labels notitle offset character 0,character 0.7 textcolor linetype 2, \
  ...
  '' using 4:($8 /1000):($4==1e-1? sprintf("%.1f", $5/$8) : "") with labels notitle offset character -1.7,character -1.2 textcolor linetype 8
